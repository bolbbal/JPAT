	    ...
	    <div class="modal-dialog" role="document">
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
	                <p>パスワ―ドを入力してください</p>
	                <input type="password" id="deletePostPassword" placeholder="password" class="form-control" />
	...
	<div class="modal fade" id="deleteReplyModalView" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel">
	    <div class="modal-dialog" role="document">
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
	                <p>パスワ―ドを入力してください</p>
	                <input type="password" id="deleteReplyPassword" placeholder="password" class="form-control" />
	...
	<script>
		...
		$(document).ready(function() {
		    ...
		    $(document).on('click', '.deleteReplyBtn', function() {
		        // userIdx를 서버에서 전역 변수로 전달받았다고 가정
		        let userIdx = '${user.userIdx}';
		        var replyIdx = $(this).data('reply-idx');

		        if (userIdx === '1') { // 관리자 계정일 경우 비밀번호 확인 없이 삭제
		            ...
		            $('#confirmReplyDelete').off('click').on('click', function() {
		                ...
		                // 비밀번호 확인 로직
		                if (password === "") {
		                    $('#deleteReplyPasswordMsg').text("パスワードを入力してください");
		                    return false;
		                }
		                ...
		                $.ajax({
		                    ...
		                    success: function(data) {
		                        if (data.result === "success") {
		                            ...
		                            $("#deleteReplyPasswordMsg").html("<span style='color:#f00;'>パスワードを確認してください</span>");
		                        }
		                    },
		                    error: function() {
		                        alert("エラーが発生しました。再度お試しください");
